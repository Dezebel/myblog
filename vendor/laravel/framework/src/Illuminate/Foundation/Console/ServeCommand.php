...
class ServeCommand extends Command
{
    ...
    {
        // Get the port option from the input or environment
        $port = $this->input->getOption('port');
    
        // If the port is null, retrieve it from the host and port getter method
        if (is_null($port)) {
        ...
        // Ensure that both $port and $this->portOffset are integers
